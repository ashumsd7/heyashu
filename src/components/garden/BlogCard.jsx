...
const BlogCard = ({ data, subPath = "/digital-garden/blog/" }) => {
  ...
  return (
    <div
      ...
      className=" rounded-lg px-2 py-2   lg:border-none hover:bg-[#f6f2e5]   transform transition-all cursor-pointer duration-200 ease-in hover:scale-[101%] hover:shadow-md "
    >
