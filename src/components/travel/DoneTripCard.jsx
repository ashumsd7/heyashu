...
function TripCard({ idx, name, img, data }) {
  ...
  return (
    <>
      {idx % 2 == 0 ? (
        <Link href={getRoute()}>
          <div className="flex gap-2 flex-wrap md:flex-nowrap w-full  border-2 border-gray-400 rounded-md justify-start shadow-md  cursor-pointer hover:shadow-2xl">
            <Image
        ...
        <Link href={getRoute()}>
          {" "}
          <div className="flex gap-2 flex-wrap w-full   rounded-md justify-start shadow-md   cursor-pointer hover:shadow-2xl border-2  border-gray-200">
