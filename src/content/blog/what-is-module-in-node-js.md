...
Let me introduce you with one of superpower of NodeJs, we will discusss it later.
...
2. Alternatively, add `1s` before the URL in the repository link to open it in a browser-based editor. For example, [https://github1s.com/](https://github1s.com/).