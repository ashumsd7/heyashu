...
export const NOTES_CONFIG = [
  ...
  {
    id: "ai-klopedia",
    title: "AI-klopedia: AI ka Gyan",
    homeTitle: "AI-klopedia: AI ka Gyan",
    ...
    completedPercent: 0,
    chapterCount: 0,
    thumbnailUrl: "https://i.ibb.co/0Vj2GbrX/ai-ka-gyan.png",
    bannerUrl: "https://i.ibb.co/0Vj2GbrX/ai-ka-gyan.png",
    isProgress: false,
    isComingSoon: true,
    isAlmostDone: false,
    ...
    githubLink: "#",
    route: "/digital-garden/notes/ai-klopedia/introduction",
    startRoute: "/digital-garden/notes/ai-klopedia/introduction",
    shortDesc:
      "AI-klopedia: Basics and practical examples of AI & Gen-AI—curated and simplified explanations, hands-on code in Python and JavaScript. Your beginner’s encyclopedia to applied AI.",
    homeDesc:
