...
export const NOTES_CONFIG = [
  {
    ...
    isComingSoon: false,
    isAlmostDone: true,
    extraChipText: "Season 01 Completed",
    tags: [FRONTEND, JAVASCRIPT, NEWBIE],
    githubLink: "https://github.com/ashumsd7/heyashu/tree/main/src/content/namaste-ai",
  ...
  {
    id: "ai-clopedia",
    title: "AI Interview QnA Handbook",
    homeTitle: "AI Interview QnA Handbook",
    by: "Ashutosh Anand Tiwari",
    authorDisplay: "Ashutosh Anand Tiwari",
    authorInitials: "AT",
    authorOrg: "Curated",
    authorAvatar: ASHUTOSH_ANAND_TIWARI_AVATAR,
    sourceName: "Curated by Ashutosh Anand Tiwari",
    sourceLink: "#",
    ...
    isComingSoon: false,
    isAlmostDone: false,
    extraChipText: "Frequently Updated",
    tags: [
      "AI",
      "GenAI",
      "interview",
    ...
    githubLink: "https://github.com/ashumsd7/heyashu/tree/main/src/content/ai-clopedia",
    route: "/ai-interview-handbook",
    startRoute: "/ai-interview-handbook",
    shortDesc:
      "AI Interview QnA Handbook: interview-ready notes on prompt engineering, LLMs, and GenAI — curated explanations with practical examples in Python and JavaScript.",
    homeDesc:
      "Interview-ready handbook for Artificial Intelligence and Generative AI: prompt engineering, zero-shot, few-shot, CoT, ReAct, and more — with examples you can use in real interviews.",
 
    homeMeta: "AI · GenAI · Interview · Prompt Engineering · Ashutosh",
    featuredOnHome: true,
    homeOrder: 2,
    isNew: true,
  },
