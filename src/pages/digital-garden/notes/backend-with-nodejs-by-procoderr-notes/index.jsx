...
const LandingPage = () => {
  ...
  const handleReadNotesClick = () => {
    router.push("/digital-garden/notes/backend-with-nodejs-by-procoderr-notes/e1-welcome"); // Redirect to the notes page
  };
  ...
  return (
    <>
      ...
      <ClassicPageLayout
        noGrid
        heading=" 🍀  Procodrr NodeJS"
        desc="   Welcome to the Procodrr NodeJS Open sourced digital notes!"
        longDesc="   Welcome to the digital garden! 🌱 This section is dedicated to
              reading notes about Node JS taught by all rounder beloved teacher Anurag Singh. 🌍 These notes are open source, allowing anyone to
