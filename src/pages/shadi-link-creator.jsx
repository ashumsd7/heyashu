...
export default function ShadiLinkCreator() {
  ...
  const handleGenerate = () => {
    ...
    const link = `${baseUrl}/events/shadi-invite?name=${encodeURIComponent(guestName.trim())}`;
  ...
  return (
    <>
      <Head>
        <title>Wedding Link Creator | Heyashu</title>
        <meta name="description" content="Generate personalized wedding invitation links" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-rose-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-12 space-y-6">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-red-600 dark:text-red-400 mb-2">
              💒 Wedding Link Creator
            </h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:border-red-500 dark:focus:border-red-400 transition-colors"
              />
            </div>

            <button
              onClick={handleGenerate}
              className="w-full bg-gradient-to-r from-red-500 to-rose-500 text-white font-serif font-semibold text-lg px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95"
            >
              Generate Link
            </button>
