...
const NamasteNodeJS = () => {
  ...
  function countTrueValues() {
    ...
    return storageValue ? Object.values(storageValue).filter(value => value === true).length : 0;
  }
  ...
  return (
    <>
      <NotesChips data={s1Episodes} handleChipClick={handleSectionClick} progress={progress} storedValues={savedStorage} />

      <div className="flex h-[93vh]">
        {isSidebarVisible && (
          <NotesSidebar data={s1Episodes} onSectionClick={handleSectionClick} progress={progress} storedValues={ls.get(STORAGE_KEY)} />
        )}
        <div
