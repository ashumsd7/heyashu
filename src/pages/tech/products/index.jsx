...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50/90 via-white to-emerald-50/80">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16 relative">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-24 bg-gradient-to-br from-green-200/30 to-emerald-300/30 rounded-full blur-2xl"></div>
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-800 via-green-700 to-gray-900 bg-clip-text text-transparent mb-6 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, index) => (
            <motion.div
              ...
              className="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-100/40 to-emerald-200/40 rounded-full blur-2xl transform translate-x-16 -translate-y-16 group-hover:translate-x-12 transition-transform duration-500"></div>
              ...
              <button     onClick={() => window.open(product.buttonLink, "_blank")} className="w-full px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl font-medium hover:from-green-700 hover:to-emerald-700 transform hover:-translate-y-0.5 transition-all duration-300 shadow-md hover:shadow-lg">
                {product.buttonText}
              </button>
            </motion.div>
          ))}
