  ...
  return (
    <>
      ...
      <motion.div 
        ...
        className="min-h-screen b      pb-12 pt-6 sm:px-6 lg:px-8 relative overflow-hidden"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div variants={fadeInUp} className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-green-800 dark:text-green-400 mb-4">
              Professional Resume
            </h1>
            <div className="w-24 h-1 bg-green-600 dark:bg-green-400 mx-auto"/>
          </motion.div>
          ...
          <div className="flex flex-col items-center gap-12">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                >
                  <Button
                    ...
                    className="w-full bg-green-700 hover:bg-green-800 dark:bg-green-600 dark:hover:bg-green-700 text-white px-6 py-3 rounded-lg flex items-center justify-center gap-2"
                  >
                ...
                <motion.button
                  ...
                  className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-3 border-2 border-green-700 dark:border-green-500 text-green-700 dark:text-green-400 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors"
                >
                  <GrFormSchedule />
                  Schedule Interview
                </motion.button>
            ...
            >
              <div onClick={onClickDirectDownload} className="cursor-pointer relative rounded-2xl overflow-hidden shadow-2xl dark:shadow-green-500/10">
                <Image
        ...
        <motion.div
          ...
          className="absolute bottom-10 left-10 text-green-600 dark:text-green-400 text-4xl opacity-30"
        >
          <PiPlantLight />
        </motion.div>
      </motion.div>
